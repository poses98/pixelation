...
func instantiate_stars():
	...
	for point in edgePoints:
		if point.y == edgePoints[0].y || point.y == edgePoints[edgePoints.size()-1].y || point.y == roundi(image.get_height()/2) || point.y == roundi(image.get_height()/2) + roundi(image.get_height()/4) || point.y == roundi(image.get_height()/2) - roundi(image.get_height()/4):
